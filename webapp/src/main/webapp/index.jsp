<html lang="en" dir="ltr">
  ...
  <body style="background-color:powderblue;">
    <h1>Hello World!</h1>
    <h2>Thanks for giving this oppurtunity</h2>
    <p>These are steps that I did for this project</p>
    <ul>
      <li>Step1: Analysing and Understanding Requirements</li>
      <ul>
      ...
      <ul>
        ...
        <li>Edit pom.xml file with required dependices</li>
      ...
      <ul>
        ...
        <li>Open Jenkins in webbrowser and install Maven, Java Plugins</li>
      ...
      <ul>
        ...
        <li>Edit all configuration files to run Tomcat</li>
        <li>Install specific plugins and create a new job to deploy war on tomcat server and enable poll scm</li>
        <li>If every thins goes good Boom! it working</li>
        <li>When ever new updated code was pushed on github then Jenkins automatically deploy war on Container</li>
      </ul>
    </ul>
    <a href="https://github.com/vamsivenkat987/Ericsson.git">Github Link</a>
  </body>
</html>
